...
public class HGamePanel extends JPanel {
	...
	public HGamePanel() {
		...
		setGeneralPath();
		addMouseListener( new HMouseListener( this ) );
		addHComputer();
	...
	public void addHComputer()
	{
		HComputer hc = new HComputer( this );

	} // end addHComputer method

	private GeneralPath shape, lines[];
	private float xPoints[] = { 9f, 183f, 193f, 0.0f };
	private float yPoints[] = { 0.0f, 0.0f, 144f, 144f };
	private float xTop[] = { 52.5f, 96f, 139.5f };
	private float xBottom[] = { 48f, 96f, 144};
	private float y[] = { 36f, 73f, 108f };
	private Container c;
